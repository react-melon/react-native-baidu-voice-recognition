...
typedef enum TBDVoiceRecognitionPlayTones
{
    ...
    EVRPlayToneAll = (EVRPlayToneTypeEnd | EVRPlayToneTypeSuccess | EVRPlayToneTypeFail | EVRPlayToneTypeCancel) // 打开所有提示音
...
typedef enum TBDVoiceRecognitionClientWorkStatus
{
    ...
    EVoiceRecognitionClientWorkStatusError,                  // 发生错误，详情见VoiceRecognitionClientErrorInfo接口通知
    /* 离线引擎状态 */
